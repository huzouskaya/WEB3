...
class Order(models.Model):
    ...
    name = models.TextField(null=True, blank=True, verbose_name="Имя заказчика")
    created_timestamp = models.DateTimeField(auto_now_add=True, verbose_name="Дата создания заказа")
    phone_number = models.CharField(max_length=20, verbose_name="Номер телефона")
    post_index = models.CharField(max_length=20, verbose_name="Почтовый индекс", default='')
    delivery_address = models.TextField(null=True, blank=True, verbose_name="Адрес доставки")
    delivery_city = models.TextField(null=True, blank=True, verbose_name="Город доставки")
